...
const Content = ({ route }) => {
  ...
  CSS: [
    { id: 21, heading: 'CSS Tutorial', subheadings: [
    ...
    { id: 22, heading: 'CSS Layout', subheadings: [
    ...
    { id: 23, heading: 'CSS Advanced', subheadings: [
    ...
    { id: 24, heading: 'CSS Responsiveness', subheadings: [
  ...
  Bootstrap:[
    { id: 31, heading: 'Bootstrap Tutorial', subheadings: [
    ...
    { id: 32, heading: 'Bootstrap Layout', subheadings: [
  ...
  const handleSubheadingPress = (url) => {
     ...
     {selectedContentData.map((item) => (
        <View key={item.id} style={styles.sectionContainer}>
          <TouchableOpacity onPress={() => toggleExpand(item.id)} style={styles.heading}>
            ...
            <Ionicons
              name={expanded[item.id] ? 'chevron-up-circle' : 'chevron-down'}
              size={25}
              color="black"
            />
          </TouchableOpacity>
          {expanded[item.id] && (
            <View style={styles.subheadings}>
              {item.subheadings.map((subheading, index) => (
                <TouchableOpacity
                key={index}
                onPress={() => handleSubheadingPress(subheading.url)}
